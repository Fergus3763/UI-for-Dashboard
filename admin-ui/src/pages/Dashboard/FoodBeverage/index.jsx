...
export default function FoodBeverage() {
  ...
  function saveOne(id) {
    ...
    console.log("FNB:SAVE_ONE", payload);
    alert(`Saved F&B item: ${it.name || "(unnamed)"} (MVP stub — see console)`);
  }
  ...
  function saveAll() {
    ...
    console.log("FNB:SAVE_ALL", payload);
    alert(`Saved ${items.length} F&B item(s). (MVP stub — see console)`);
  }
  ...
  function normalize(it) {
    return {
      ...
      unit_label: it.unit_label || "item(s)",
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1000, margin: "0 auto" }}>
      <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ margin: 0 }}>F&amp;B — Admin</h1>
        <div style={{ display: "flex", gap: 8 }}>
          <button onClick={saveAll}>Save All (F&amp;B)</button>
          <button onClick={addItem}>Add another F&amp;B item</button>
        </div>
      </header>
        ...
        return (
          <section key={it.id} style={card}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <h2 style={{ margin: 0 }}>F&amp;B Item {idx + 1}</h2>
              <div style={{ display: "flex", gap: 8 }}>
            ...
            <div style={grid2}>
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Coffee & Pastries AM"
                />
