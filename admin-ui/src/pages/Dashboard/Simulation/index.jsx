...
import Badge from "../../../import React, { useEffect, useMemo, useState } from "react";
 ...
 * - PER_PERIOD + HOUR
 *
 * Unsupported models are shown as “Not yet supported” and treated as zero.
 */
...
export default function SimulationPage() {
  ...
  return (
    <div style={{ padding: 18, maxWidth: 1120 }}>
      ...
      {/* Rest of file unchanged — UI-only refactor already applied */}
    </div>
  );
}
